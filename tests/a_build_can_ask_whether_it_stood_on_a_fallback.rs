...
//!    [`run_to_completion_watched`](libpipeline::run_to_completion_watched)
...
use libpipeline::{
    Chain, Guarded, NoPendingWork, Substitutions, run_to_completion, run_to_completion_counted,
};
...
fn a_frame_loop_takes_the_same_measurement_by_differencing_the_tally() {
    ...
    let driver = libpipeline::FrameDriver::new();
    let input = Text("src".into());
